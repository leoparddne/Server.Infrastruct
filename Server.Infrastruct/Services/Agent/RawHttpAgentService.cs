...
namespace Server.Infrastruct.Services.Agent
{
    public class RawHttpAgentService : IRawHttpAgentService
    {
        ...
        public async Task<T?> PostFormDataAsync<T>(string url, Dictionary<string, object>? parameters = null, Dictionary<string, string>? Headers = null) where T : class?
        {
        ...
        public T? PostFormData<T>(string url, Dictionary<string, object>? parameters = null, Dictionary<string, string>? Headers = null) where T : class?
        {
