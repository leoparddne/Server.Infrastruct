namespace Server.Domain.Models.Enums.Common
{
    /// <summary>
    /// 文件类型
    /// </summary>
    public enum FileTypeEnum
    {
        ...
        CSV = 6,
        /// <summary>
        /// ("doc","微软Word文件","application/msword")
        /// </summary>
        DOC = 7,
        /// <summary>
        ...
        XLS = 26,
        /// <summary>
        /// ("xlsx","微软Excel（OpenXML）","application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
        /// </summary>
        XLSX = 27,
        /// <summary>
